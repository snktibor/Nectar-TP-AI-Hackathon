  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'phantom-pulse-soft': 'phantom-pulse-soft 3.2s ease-in-out infinite',
        'phantom-pulse-ring': 'phantom-pulse-ring 3s ease-out infinite',
        'phantom-pulse-dot': 'phantom-pulse-dot 3s ease-in-out infinite',
        'phantom-bounce-in': 'phantom-bounce-in 160ms cubic-bezier(0.2, 0.8, 0.2, 1) both',
        'phantom-progress-glow': 'phantom-progress-glow 3.4s ease-in-out infinite',
      },
    },
  },
  plugins: [],
