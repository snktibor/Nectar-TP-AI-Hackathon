...
export default {
  ...
  theme: {
    extend: {
      ...
      transitionProperty: {
        phantom: 'color, background-color, border-color, transform, opacity',
      },
      keyframes: {
        'phantom-fade-in': {
          from: { opacity: '0' },
        ...
        'phantom-pulse-ring': {
          ...
          '70%': { transform: 'scale(1.08)', opacity: '0.65' },
      ...
      animation: {
        'phantom-fade-in': 'phantom-fade-in 180ms ease-out both',
        'phantom-fade-in-up': 'phantom-fade-in-up 260ms cubic-bezier(0.2, 0.8, 0.2, 1) both',
        ...
        'phantom-slide-in-right': 'phantom-slide-in-right 260ms cubic-bezier(0.2, 0.8, 0.2, 1) both',
